...
import Profile, { AppVersion } from "../Common/Profile";
...
const FLDrawer = () => {
    ...
    return (
        <Drawer.Navigator screenOptions={{ headerShown: false }} drawerContent={(props) => <CustomDrawer {...props} />} >
            ...
            <Drawer.Screen name="Manage EBT Account" component={EBTCardStackNav} options={{ drawerIcon: () => <PencilSquareIcon name="fl-home" size={IconSize} color={IconColor} style={{ marginRight: -25 }} />, title: t('pageTitles.manageEBTAccount') }} />
            ...
            <Drawer.Screen name="Feedback" component={FeedbackStackNav} options={{ drawerIcon: () => <PencilIcon name="fl-home" size={IconSize} color={IconColor} style={{ marginRight: -25 }} />, title: t('pageTitles.feedback') }} />
