...
import { ClinicService, fetchCoordinates } from '../Services/apiService';
...
export default function Clinics({ navigation }) {
  ...
  const getClinics = async () => {
    ...
    try {
      const clinicResponse = await ClinicService(latLng.lat, latLng.lng, miles, newAbortController.signal);
      if (clinicResponse) {
