...
export const { setProfileEmail, setProfileFullName, setGlobalError, setClearProfileData, setToken, setProfileLanguage, setEBTCardNumber, setScannedUPC, setLoginType, } = profileSlice.actions;
